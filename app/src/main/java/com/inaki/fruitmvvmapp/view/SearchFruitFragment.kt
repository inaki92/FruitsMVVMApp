 ...
 * Use the [SearchFruitFragment.newInstance] factory method to
...
class SearchFruitFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_search_fruit, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment SearchFruitFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SearchFruitFragment().apply {
